...
const perguntarAI = async (question, game, apiKey) => {
    ...
    -Se a pergunta não está relacionada ao jogo, responda com 'Essa pergunta não está relacionada
    com o jogo'.
...
const enviarFormulario = async (event) => {
    ...
    try {
        ...
        aiResponse.querySelector('.response-content').innerHTML = '<p style="color:red;">Erro ao consultar a IA.</p>'
    } finally {
